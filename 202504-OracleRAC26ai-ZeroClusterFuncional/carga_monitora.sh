...
# ======================================================================
# monitor_alertlog.sh
# Monitoramento em tempo real dos alert logs do CRS e das instancias
# de banco Oracle RAC 26ai — DBA Sobrinho
#
# Uso: bash /home/oracle/scripts_carga/monitor_alertlog.sh
# ======================================================================
